...
function default_1(options) {
    return async (host) => {
        ...
        if (project && options.path === undefined) {
            optPath = workspace_1.buildDefaultPath(project);
        }
        options.module = findRoutingModuleFromOptions(host, options);
        const parsedPath = parse_name_1.parseName(optPath, options.name);
        options.name = parsedPath.name;
        options.path = parsedPath.path;
        options.selector = options.selector ? options.selector : util_1.buildSelector(options, (_b = (_a = project) === null || _a === void 0 ? void 0 : _a.prefix, (_b !== null && _b !== void 0 ? _b : 'app')));
        ...
        return schematics_1.chain([
            schematics_1.branchAndMerge(schematics_1.chain([addRouteToNgModule(options), schematics_1.mergeWith(templateSource)])),
        ]);
    };
}
