...
var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: function () { return Promise.resolve().then(function () { return require('./travel/explore/explore.module'); }).then(function (m) { return m.ExplorePageModule; }); }
            },
            {
                path: ':id',
                loadChildren: function () { return Promise.resolve().then(function () { return require('./travel/explore-details/explore-details.module'); }).then(function (m) { return m.ExploreDetailsPageModule; }); }
            },
        ]
    },
    {
