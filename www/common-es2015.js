...
let url = 'https://5f40bf70a5e9db0016302048.mockapi.io';
const apiEndPoints = {
    travel: `${url}/travel`
};
...
/* harmony import */ var _commom_api_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../commom/api.config */ "./src/app/commom/api.config.ts");
...
let TravelService = class TravelService {
    ...
    //get all product
    getAllTravels() {
        let url = _commom_api_config__WEBPACK_IMPORTED_MODULE_2__["apiEndPoints"].travel;
        try {
    ...
    // getProductById
    getTravelById(id) {
        let url = `${_commom_api_config__WEBPACK_IMPORTED_MODULE_2__["apiEndPoints"].travel}/${id}`;
        try {
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => {
                return res;
            }));
...
TravelService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
